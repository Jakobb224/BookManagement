...
<body>
    <nav>
        <button class="button" onclick="quit()" style="background-color: red; margin-right: 15px;">
            Backup verlassen
        </button>
    ...
    <div class="center">
        <button class="button" style="margin-right: 10px;" onclick="search()">Suchen</button>
        <button class="button" onclick="add()">Hinzufügen oder Löschen</button>
    </div>
